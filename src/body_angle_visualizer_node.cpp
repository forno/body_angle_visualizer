...
int main(int argc, char** argv)
{
  ...
  while (ros::ok()) {
    try {
      ...
      const auto torso_yrp {torso_pos.rotation().eulerAngles(1, 2, 0)};
      ...
      rvt.publishText(text_pos, std::to_string(torso_yrp(1)), rviz_visual_tools::WHITE, rviz_visual_tools::XLARGE);
